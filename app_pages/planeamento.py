...
def render(df, excel_path, **kwargs):
    ...
    _vista_plan = st.selectbox(
        "Vista",
        ["⚽ Jogo vs Treino", "📊 Treino vs Jogo %", "📋 Planeado vs Realizado", "🧮 Calculadora de Exercícios", "📐 Espaço & Carga Externa"],
        key="sel_vista_plan", label_visibility="collapsed"
    )

    _PLAN_LABELS = ["⚽ Jogo vs Treino","📊 Treino vs Jogo %","📋 Planeado vs Realizado","🧮 Calculadora de Exercícios","📐 Espaço & Carga Externa"]
