...
from app.routers import analise, avancado, carga_externa, combinada, comparacoes, configuracoes, dashboard, equipa, filtros, health, ia, ingest, jogadores, lesoes, match_benchmark, perfil, planeamento, relatorio, sessoes, sistema, velocidade, wellness
...
app.include_router(velocidade.router)
