...
from app.routers import analise, avancado, carga_externa, comparacoes, dashboard, equipa, health, ingest, jogadores, match_benchmark, planeamento, relatorio, sessoes, sistema
